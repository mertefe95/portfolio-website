        ...
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex justify-around">
            ...
            <li className="p-4">
              {/** not good */}
              <Button variant="contained">
                <a href="https://cafe-shop-react-tailwindcss.vercel.app">
                  View on Vercel
                </a>
              </Button>
            </li>
          ...
          <ul className="flex flex-col justify-around items-center">
            <li>
              <Chip
                label="React JS ( CRA + ReactRouterDom)"
                color="primary"
              />
            </li>
            <li>
      ...
      <Grid item xs={12} md={6}>
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex">
            <li className="p-4">
              <Button variant="contained">
                <a href="https://github.com/mertefe95/nyx-bar-project">
                  View on Github
                </a>
              </Button>
            </li>
            <li className="p-4">
              <Button variant="contained">
                <a href="https://nyx-bar-project.vercel.app">
                  View on Vercel
                </a>
              </Button>
            </li>
      ...
      <Grid item xs={12} md={6}>
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex">
            <li className="p-4">
              <Button variant="contained">
                <a href="https://github.com/mertefe95/js-social-project">
                  View on Github
                </a>
              </Button>
            </li>
            <li className="p-4">
              <Button variant="contained">
                <a href="https://js-social-project.vercel.app/">
                  View on Vercel
                </a>
              </Button>
            </li>
      ...
      <Grid item xs={12} md={6}>
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex">
            <li className="p-4">
              <Button variant="contained">
                <a href="https://github.com/mertefe95/tip-calculator">
                  View on Github
                </a>
              </Button>
            </li>
            <li className="p-4">
              <Button variant="contained">
                <a href="https://tip-calculator-xi.vercel.app/">
                  View on Vercel
                </a>
              </Button>
            </li>
      ...
      <Grid item xs={12} md={6}>
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex">
            <li className="p-4">
              <Button variant="contained">
                <a href="https://github.com/mertefe95/fanbird-web-1">
                  View on Github
                </a>
              </Button>
            </li>
          ...
          <ul className="flex flex-col justify-around items-center">
            ...
            <li>
              <Chip
                label="TailwindUI Components & Templates"
                color="primary"
              />
            </li>
          </ul>
      ...
      <Grid item xs={12} md={6}>
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex">
            ...
            <li className="p-4">
              <Button variant="contained">
                <a href="https://assignment-project-react-tailwind.vercel.app/">
                  View on Vercel
                </a>
              </Button>
            </li>
      ...
      <Grid item xs={12} md={6}>
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex">
            <li className="p-4">
              <Button variant="contained">
                <a href="https://github.com/mertefe95/Followups.co-project/">
                  View on Github
                </a>
              </Button>
            </li>
            <li className="p-4">
              <Button variant="contained">
                <a href="https://followups-co-project.vercel.app">
                  View on Vercel
                </a>
              </Button>
            </li>
      ...
      <Grid item xs={12} md={6}>
        <Paper className={classes.paper}>
          ...
          <ul className="buttons flex">
            <li className="p-4">
              <Button variant="contained">
                <a href="https://github.com/mertefe95/portfolio-website">
                  View on Github
                </a>
              </Button>
            </li>
