    ...
    <header className="header h-40 bg-white flex items-center">
      ...
      <nav className="nav flex absolute right-0 pr-10 font-black md:px-10 sm:mx-24">
        ...
        <ul className="icons flex sm:flex-col">
          <li className="px-4">
            <a href="https://www.instagram.com/mertefeisikgor/">
              <FontAwesomeIcon icon={faInstagram} />
            </a>
          </li>
          <li className="px-4">
            <a href="https://www.facebook.com/efeisikgor/">
              <FontAwesomeIcon icon={faFacebook} />
            </a>
          </li>
          <li className="px-4">
            <a href="https://github.com/mertefe95">
              <FontAwesomeIcon icon={faGithub} />
            </a>
          </li>
          <li className="px-4">
            <a href="https://www.linkedin.com/in/mert-efe-i%C5%9F%C4%B1kg%C3%B6r-997712164/">
