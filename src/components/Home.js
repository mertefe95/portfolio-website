...
<main className="main flex flex-col justify-center items-center h-screen pb-64 text-white text-center md:mx-20">
    <h2 className="text-5xl pb-4 md:text-xl">Hello, I'm Mert Efe Isikgor. <FontAwesomeIcon icon={faSmile}/> </h2>
    <h2 className="text-5xl pb-4 md:text-xl">I'm a Jr. Web Developer <FontAwesomeIcon icon={faThumbsUp}/> </h2>
